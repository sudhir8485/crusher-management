            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Centre: plate, owner/type, linked machine — Expanded
                  Expanded(
                    child: Column(
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () => _toggleActive(context, ref, v['id'] as int, plate),
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                DropdownMenuItem(value: 'TENANT', child: Text('Own')),
                DropdownMenuItem(value: 'VENDOR', child: Text('Party')),
              ],
